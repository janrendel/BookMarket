package kr.ac.kopo.janrendel11.bookmarket.domain;

import jakarta.validation.constraints.*;
import kr.ac.kopo.janrendel11.bookmarket.validator.BookId;
import lombok.Data;
...
public class Book {
    @BookId
    @Pattern(regexp = "isbn[0-9]+",message = "{Pattrn.book.bookId}")
